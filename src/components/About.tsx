        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 animate-fade-in">
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-700">
              ...
              <p className="text-gray-300 leading-relaxed mb-6">
                Recent Computer Science graduate with hands-on experience
                building scalable web applications using modern JavaScript
                frameworks and Python. Demonstrated expertise in full-stack
                development through multiple projects including e-commerce
                platforms and data analytics dashboards. Proficient in React,
                Node.js, MongoDB, and responsive design principles. .
              </p>
              <p className="text-gray-300 leading-relaxed">
                Passionate about creating user-centered digital solutions that
                solve real-world business problems. Seeking to leverage strong
                technical foundation and problem-solving skills in a challenging
                development role.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-teal-500/20 to-cyan-500/20 backdrop-blur-sm rounded-2xl p-8 border border-teal-500/30">
              ...
              <p className="text-gray-300 leading-relaxed">
                I focus on understanding business requirements, implementing
                scalable solutions, and delivering projects that exceed
                expectations. From database design to user interface
                implementation, I ensure every aspect is crafted with precision.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6 animate-fade-in delay-300">
            ...
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-700/50 backdrop-blur-sm rounded-xl p-6 border border-gray-600">
              ...
              <p className="text-teal-400 font-semibold mb-1">
                Attained A KCSE Certificate - 2019
              </p>
